...
#define STEERING_VOLTS_HIGH_TO_TORQUE( volts ) (\
            ((volts / STEPS_PER_VOLT) - TORQUE_SPOOF_HIGH_SIGNAL_CALIBRATION_CURVE_OFFSET) / TORQUE_SPOOF_HIGH_SIGNAL_CALIBRATION_CURVE_SCALE)
